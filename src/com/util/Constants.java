...
public class Constants {
    ...
    public static final String MAIL_TEMPLATE_FILE = "src/Resources/MailTemplate.xml";
    
    //tool tip
    public static final String MAIL_TOOL_TIP = "eg: abc@gmail.com,tom@gmail.com (comma seperated)";
